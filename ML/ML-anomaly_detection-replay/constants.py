...
# demo or replay variables. If 'is_replay' is set, 'time_shift' will be calculated based on mdt_db-200116 timeframe
is_replay = True
time_shift = ' - 0d '
start_time = datetime(2021, 3, 10) # replay start time y, m, d
time_accelerator = 1.0 # in replay mode, 1 is normal time speed, 5 is playing 10 minutes in 2 minutes
...
fig_color = '#d5ffff'   # figures background color = very light blue
